...
#include "../include/enot_scaner_delimiter_table.h"
...
namespace enot_scanner{
    ...
    {{U'[', U'['},  32        },    {{U'8', U'9'},  1085448   },
    {{U'x', U'x'},  524428    },    {{U'+', U'+'},  262176    },
    {{U'I', U'I'},  28        },    {{U'f', U'f'},  528396    },    
    {{U'ж', U'з'},  12        },    {{U'$', U'$'},  2048      },
    {{U'/', U'/'},  32        },    {{U'C', U'D'},  4108      },
    {{U'R', U'R'},  28        },    {{U'b', U'b'},  4364      },    
    {{U'o', U'o'},  524       },    {{U'А', U'а'},  12        }, 
	{{U'х', U'х'},  12        },    {{U'"', U'"'},  64        },
    {{U''', U'''},  1024      },    {{U'-', U'-'},  262176    },    
    {{U'1', U'1'},  1110024   },    {{U'A', U'A'},  4108      },
    {{U'F', U'F'},  4108      },    {{U'O', U'O'},  524       },
    {{U'X', U'X'},  140       },    {{U'_', U'_'},  12        },    
    {{U'd', U'd'},  528396    },    {{U'm', U'm'},  28        }, 
	{{U'q', U'q'},  524300    },    {{U'{', U'~'},  32        }, 
	{{U'г', U'г'},  12        },    {{U'й', U'к'},  12        },  
    {{U'щ', U'я'},  12        },    {{U'!', U'!'},  32        },  
	{{U'#', U'#'},  32        },    {{U'%', U'&'},  32        },  
	{{U'(', U'*'},  32        },    {{U',', U','},  32        },    
    {{U'.', U'.'},  2097184   },    {{U'0', U'0'},  126984    },    
	{{U'2', U'7'},  1093640   },    {{U':', U'@'},  32        },  
	{{U'B', U'B'},  4364      },    {{U'E', U'E'},  135180    },    
    {{U'G', U'H'},  12        },    {{U'J', U'N'},  12        },    
	{{U'P', U'Q'},  12        },    {{U'S', U'W'},  12        },   
	{{U'Y', U'Z'},  12        },    {{U']', U'^'},  32        },    
    {{U'a', U'a'},  4108      },    {{U'c', U'c'},  4108      },
    {{U'e', U'e'},  135180    },    {{U'g', U'l'},  12        },
    {{U'n', U'n'},  12        },    {{U'p', U'p'},  12        },    
    {{U'r', U'w'},  12        },    {{U'y', U'z'},  12        },
    {{U'Ё', U'Ё'},  12        },    {{U'б', U'в'},  28        },
	{{U'д', U'е'},  28        },    {{U'и', U'и'},  28        },  
    {{U'л', U'ф'},  28        },    {{U'ц', U'ш'},  28        },
    {{U'ё', U'ё'},  12        },  
    {{   1,   32},  1         }
    };
...
//             token_.lexeme_.char_val_ = char_code_;
    ...
    static const std::string code_names[] = {
        ...
        "Kw_besconechno",              "Kw_bolshoe",                  
        "Kw_veshch",                   "Kw_veshch32",
        "Kw_veshch64",                 "Kw_veshch80",
        "Kw_veshch128",                "Kw_vernut",
		"Kw_vkl",                      "Kw_vykl",
